            ...
            {movie &&
                <div className="movie-box">
                    <div className="detail-poster"
                        style={{ backgroundImage: `url(https://www.themoviedb.org/t/p/w300_and_h450_bestv2${movie.poster_path})` }}></div>
                    <br />
                    <div className="detail-item">
                        {/* react-bootstrap Badge */}
                        <div>
                            {movie.adult ? <Badge bg="secondary">전체관람가</Badge> : <Badge bg="success">청소년 관람 불가</Badge>}
                        </div>
                        <h1>{movie.title}</h1>
                        <div>
